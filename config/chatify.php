...
return [
    ...
    |-------------------------------------
    */
    'name' =>env('APP_COMPANY_NAME', 'سامانه'),
    ...
    */
    'attachments' => [
        ...
        'allowed_files' => (array) ['zip','rar','txt',"xls","xlsx","doc","docx","pdf"],
        'max_upload_size' => env('CHATIFY_MAX_FILE_SIZE', 20), // MB
    ],
    ...
    */
    'sounds' => [
        'enabled' => true,
        'public_path' => 'assets/voice/',
        'new_message' => 'chatify.mp3',
    ]
];
