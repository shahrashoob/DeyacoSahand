...
use App\Http\Controllers\GoodsKindProcess\Warps\Matthys;
use App\Http\Controllers\GoodsKindProcess\Warps\Matthys\Machine\RequestRawMaterialController;

Route::name( "machine_allocation." )->prefix( "/machine_allocation" )->group( function () {
    Route::get( "index/{production}/{machine_type}", [
        Matthys\ProductionCard\MachineAllocationController::class,
        "index"
    ] )->name( "index" );
...
Route::name( "machine." )->prefix( "/machine" )->group( function () {
    ...
    Route::name( "dashboard." )->prefix( "/dashboard" )->group( function () {
        Route::match( [ 'get', 'post' ], "index", [
            Matthys\Machine\DashboardController::class,
            "index"
        ] )->name( "index" );

        Route::get( "view/{machine}", [ Matthys\Machine\DashboardController::class, "view" ] )->name( "view" );
    ...
    Route::name( "end_of_beaming." )->prefix( "/end_of_beaming" )->group( function () {
        Route::get( "index/{machine}", [
            Matthys\Machine\EndOfBeamingController::class,
            "index"
        ] )->name( "index" );
    ...
    Route::name( "start_beaming." )->prefix( "/start_beaming" )->group( function () {
        Route::get( "index/{machine}", [
            Matthys\Machine\StartBeamingController::class,
            "index"
        ] )->name( "index" );
    ...
    Route::name( "end_of_shelving." )->prefix( "/end_of_shelving" )->group( function () {
        Route::get( "index/{machine}", [
            Matthys\Machine\EndOfShelvingController::class,
            "index"
        ] )->name( "index" );
    ...
    Route::name( "end_of_warping." )->prefix( "/end_of_warping" )->group( function () {
        Route::get( "index/{machine}", [
            Matthys\Machine\EndOfWarpingController::class,
            "index"
        ] )->name( "index" );
    ...
    Route::name( "start_warping." )->prefix( "/start_warping" )->group( function () {
        Route::get( "index/{machine}", [
            Matthys\Machine\StartWarpingController::class,
            "index"
        ] )->name( "index" );
    ...
    Route::name( "material_delivery_confirmation." )->prefix( "/material_delivery_confirmation" )->group( function () {
        Route::get( "index/{machine}", [
            Matthys\Machine\MaterialDeliveryConfirmationController::class,
            "index"
        ] )->name( "index" );
        Route::post( "submit/{machine}", [
            Matthys\Machine\MaterialDeliveryConfirmationController::class,
    ...
    Route::name( "material_delivery_reject." )->prefix( "/material_delivery_reject" )->group( function () {
        Route::get( "index/{machine}", [
            Matthys\Machine\MaterialDeliveryRejectController::class,
            "index"
        ] )->name( "index" );
        Route::post( "submit/{machine}", [
            Matthys\Machine\MaterialDeliveryRejectController::class,
    ...
    Route::name( "injection_of_material." )->prefix( "/injection_of_material" )->group( function () {
        Route::get( "index/{machine}", [
            Matthys\Machine\InjectionOfMaterialController::class,
            "index"
        ] )->name( "index" );
        Route::post( "submit/{machine}", [
            Matthys\Machine\InjectionOfMaterialController::class,
    ...
    Route::name( "material_return_to_warehouse." )->prefix( "/material_return_to_warehouse" )->group( function () {
        Route::get( "index/{machine}", [
            Matthys\Machine\MaterialReturnToWarehouseController::class,
            "index"
        ] )->name( "index" );
    ...
    Route::name( "waste_collection." )->prefix( "/waste_collection" )->group( function () {
        Route::get( "index/{machine}", [
            Matthys\Machine\WasteCollectionController::class,
            "index"
        ] )->name( "index" );
    ...
    Route::name( "request_raw_material." )->prefix( "/request_raw_material" )->group( function () {
        Route::get( "index/{machine}", [
            Matthys\Machine\RequestRawMaterialController::class,
            "index"
        ] )->name( "index" );
        Route::post( "submit/{machine}", [
            Matthys\Machine\RequestRawMaterialController::class,
    ...
    // M 12: MaterialReturnToWarehouseLogController
    Route::name( "material_return_to_warehouse_log." )->prefix( "/material_return_to_warehouse_log" )->group( function () {
        Route::get( "index/{machine}", [
            Matthys\Machine\MaterialReturnToWarehouseLogController::class,
            "index"
        ] )->name( "index" );
    ...
    // M 1: FailureShelvingController
    Route::name( "failure_shelving." )->prefix( "/failure_shelving" )->group( function () {
        Route::get( "index/{machine}", [
            Matthys\Machine\FailureShelvingController::class,
            "index"
        ] )->name( "index" );
    ...
    Route::name( "allocation_card." )->prefix( "/allocation_card" )->group( function () {
        ...
        Route::match( [ 'get', 'post' ], "index/{machine}/{allocation_id?}", [
            Matthys\Machine\AllocationCardController::class,
            "index"
        ] )->name( "index" );
    ...
    Route::name( "finished_allocation." )->prefix( "/finished_allocation" )->group( function () {
        Route::get( "index/{machine}", [
            Matthys\Machine\FinishedAllocationController::class,
            "index"
        ] )->name( "index" );
    ...
    Route::name( "log." )->prefix( "/log" )->group( function () {
        Route::match(['get', 'post'],"index/{machine}", [ Matthys\Machine\LogController::class, "index" ] )->name( "index" );
    } );
