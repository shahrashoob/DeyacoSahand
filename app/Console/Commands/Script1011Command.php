...
class Script1011Command extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'script:s1011';
     ...
     * @var string
     */
    protected $description = 'Bot Production : Update Production Amount ';
