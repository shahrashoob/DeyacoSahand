...
{
    public static $info = [
        "route" => "fabric.finishing_machine.machine.confirm_quality_control.",
        "enable_status" => ["905"],
        "button" => ["caption" => "تایید کنترل کیفیت", "class" => "btn-primary"],
        "message" => ["confirm" => "آیا از تایید کنترل کیفیت اطیمنان دارید؟"],
    ...
    {
       // return back()->withErrors("این ماژول از لیست ماشین های عمومی حذف شده است.");
        ...
        $machineLog->machine_event_type_id = 5310905; // تایید کنترل کیفیت

        $next_status_result = DashboardController::GetNextStatus($machine, $allocation, $machine->production_status_id, 5310905, true);
