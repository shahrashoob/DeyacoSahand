...
class MaterialDeliveryConfirmationController extends Controller {
    public static $info = [
        "route"         => "fabric.finishing_machine.machine.material_delivery_confirmation.",
        "enable_status" =>["001","002","003","901","902","903","904","905" ],
        "button"        => [ "caption" => "تایید تحویل مواد اولیه از انبار", "class" => "btn-success" ],
        "view_path"     => "goods_kind_process.fabric.finishing_machine.machine.material_delivery_confirmation.",
    ];
    var $view_path;
    var $route_path;
