...
class MakeFinalSettingController extends Controller
{
    public static $info = [
        "route" => "fabric.finishing_machine.machine.make_final_setting.",
        "enable_status" => ["904"],
        "button" => ["caption" => "انجام تنظیمات نهایی", "class" => "btn-primary"],
        "message" => ["confirm" => "آیا از انجام تنظیمات نهایی اطیمنان دارید؟"],
    ...
    public function submit(Machine $machine)
    {
        ...
        $machineLog->machine_event_type_id = 5310904; // انجام تنظیمات نهایی

        $next_status_result = DashboardController::GetNextStatus($machine,$allocation, $machine->production_status_id, 5310904, true);
