...
{
    public static $info = [
        "route" => "fabric.finishing_machine.machine.material_return_to_warehouse.",
        "enable_status" => ["001", "002", "003","901","902","903","904","905"],
        "button" => ["caption" => "برگشت مواد اولیه به انبار", "class" => "btn-primary"],
        "view_path" => "goods_kind_process.fabric.finishing_machine.machine.material_return_to_warehouse.",
    ];
    var $view_path;
    var $route_path;
    var $dashboard_route = "fabric.finishing_machine.machine.dashboard.";
    var $route_log_path = "fabric.finishing_machine.machine.material_return_to_warehouse_log.";
