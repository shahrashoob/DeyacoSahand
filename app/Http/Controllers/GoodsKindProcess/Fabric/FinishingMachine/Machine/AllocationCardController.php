...
class AllocationCardController_delete extends Controller {
    //
    public static $info = [
        "route"         => "fabric.finishing_machine.machine.allocation_card.",
        "enable_status" => ["001","002","003","901","902","903","904","905" ],
        "button"        => [ "caption" => " پرینت کارت تخصیص ", "class" => "btn-info" ],
        "view_path"     => "goods_kind_process.fabric.finishing_machine.machine.allocation_card.",
