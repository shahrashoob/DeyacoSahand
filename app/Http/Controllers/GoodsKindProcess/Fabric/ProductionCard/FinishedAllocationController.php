...
{
    public static $info = [
        "route" => "fabric.production_card.finished_allocation.",
        "enable_status" => ["001", "002", "003", "903", "004","005"],
        "button" => ["caption" => "مشاهده سابقه تخصیص", "class" => "btn-info"],
        "view_path" => "goods_kind_process.fabric.production_card.finished_allocation.",

    ];
    var $view_path;
    var $route_path;
    var $dashboard_route = "fabric.production_card.dashboard.";
