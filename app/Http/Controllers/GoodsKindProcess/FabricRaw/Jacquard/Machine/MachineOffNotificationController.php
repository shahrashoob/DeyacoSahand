...
use App\Http\Controllers\GoodsKindProcess\General\Machine\GeneralMachineOffNotificationController;
use App\Models\LineProduct\Machine\Machine;
use Illuminate\Http\Request;

class MachineOffNotificationController extends Controller
{
    public static $info = [
    ...
    var $route_path;
     ...
     var $off_notification_route = "fabric_raw.jacquard.machine.off_notification.";
    ...
    public function getGeneralController(): GeneralMachineFaultNotificationController {
