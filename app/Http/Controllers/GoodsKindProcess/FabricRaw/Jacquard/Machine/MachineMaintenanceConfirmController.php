...
use App\Http\Controllers\GoodsKindProcess\General\Machine\GeneralMachineFaultNotificationConfirmController;
use App\Http\Controllers\GoodsKindProcess\General\Machine\GeneralMachineFaultNotificationController;
use App\Http\Controllers\GoodsKindProcess\General\Machine\GeneralMachineMaintenanceConfirmController;
use App\Models\LineProduct\Machine\Machine;
use App\Models\LineProduct\Machine\Maintenance\Maintenance;
use Illuminate\Http\Request;

class MachineMaintenanceConfirmController extends Controller
{
    public static $info = [
        "route"         => "fabric_raw.jacquard.machine.machine_maintenance_confirm.",
        "enable_status" => [
            "001",
            "002",
            "003",
        ...
        "button"        => [ "caption" => " عملیات نت", "class" => "btn-success" ]
    ];
    var $route_path;
    ...
    public function confirm( Request $request, Machine $machine,Maintenance $maintenance) {
        ...
        return $publicController->confirm( $request, $machine,$maintenance );
    }
    ...
    public function reject( Request $request, Machine $machine,Maintenance $maintenance) {
        ...
        return $publicController->reject( $request, $machine,$maintenance );
    }

    public function getGeneralController() {
        $publicController                  = new GeneralMachineMaintenanceConfirmController();
