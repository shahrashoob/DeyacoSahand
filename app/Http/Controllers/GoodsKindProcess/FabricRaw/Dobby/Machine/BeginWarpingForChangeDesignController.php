...
{
    public static $info = [
        "route"         => "fabric_raw.machine.begin_warping_for_change_design.",
        "enable_status" => [ "031" ],
        "button"        => [ "caption" => "شروع گره زنی (تغییر کالیته)", "class" => "btn-primary" ],
        "view_path"     => "goods_kind_process.fabric_raw.machine.begin_warping_for_change_design.",
    ...
    public function __construct() {
        ...
        $this->view_path  = BeginWarpingForChangeDesignController::$info["view_path"];
    }
