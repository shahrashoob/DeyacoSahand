...
use App\Http\Controllers\GoodsKindProcess\Warps\Matthys\ProductionCard\DashboardController;
...
class ProductionCardController extends Controller {
    ...
    public $view_path = "goods_kind_process.warps.production_card.";
    public $route_path = "goods_kind_process.warps.production_card.";
