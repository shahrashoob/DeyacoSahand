...
{
    public static $info = [
        "route" => "warps.matthys.machine.material_return_to_warehouse_log.",
        "enable_status" => ["001", "002", "003", "004", "005", "006", "007", "008", "009", "010", "011", "012"],
        "button" => ["caption" => "مشاهده سابقه برگشت مواد اولیه", "class" => "btn-primary"],
        "view_path" => "goods_kind_process.warps.matthys.machine.material_return_to_warehouse_log.",
