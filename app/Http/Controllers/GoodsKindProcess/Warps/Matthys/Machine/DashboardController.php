...
class DashboardController extends Controller {
    ...
    public static $info = [
        "route" => "warps.matthys.machine.dashboard."
    ];
    var $view_path = "goods_kind_process.warps.matthys.machine.dashboard.";
...
//        $result["05"] = isset( $warps_request_form );
    ...
    public static function get_controller_info( $type = "" ) {
        $controller_info = [
            "01" => EndOfBeamingController::$info,
            "02" => StartBeamingController::$info,
