...
class ConfirmStep1Controller extends Controller
{
    public static $info = [
        "route" => "wh.warehouse_handling.confirm_step1.",
        "enable_status" => ["311"],
        "button" => ["caption" => "تایید انبارگردانی مرحله اول", "class" => "btn-primary"],
    ...
    public function submit(WarehouseHandling $warehouse_handling)
    {
        ...
        $warehouse_handling->status_id = 524000312; // در انتظار تایید مرحله دوم
        $warehouse_handling->save();
        event(new WarehouseHandlingEvent($warehouse_handling, 524000304));
