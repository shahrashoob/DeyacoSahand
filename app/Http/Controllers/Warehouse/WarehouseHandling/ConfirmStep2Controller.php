...
class ConfirmStep2Controller extends Controller
{
    public static $info = [
        "route" => "wh.warehouse_handling.confirm_step2.",
        "enable_status" => ["312"],
        "button" => ["caption" => "تایید انبارگردانی مرحله دوم", "class" => "btn-primary"],
    ...
    public function submit(WarehouseHandling $warehouse_handling)
    {
        ...
        $warehouse_handling->status_id = 524000313; // در انتظار تایید مرحله سوم
        $warehouse_handling->save();
        event(new WarehouseHandlingEvent($warehouse_handling, 524000305));
