...
{
    public static $info = [
        "route" => "wh.warehouse_handling.reject.",
        "enable_status" => ["301","302","304","311","312","313"],
        "button" => ["caption" => "عدم تایید انبارگردانی", "class" => "btn-danger"],
        "message" => ["confirm" => "آیا از عدم تایید انبارگردانی اطمینان دارید؟"],
        "view_path" => "",
    ...
    public function submit(WarehouseHandling $warehouse_handling)
    {
        ...
        $warehouse_handling->status_id = 524000323; // عدم تایید
        $warehouse_handling->save();
        WarehouseProductBlock::UpdateBlockedByWarehouseHandling($warehouse_handling);
        event(new WarehouseHandlingEvent($warehouse_handling, 524000308));

        return back()->with(["success" => "عدم تایید انبارگردانی با موفقیت ثبت گردید"]);
    }
