...
class Step2DesignController extends Controller
{
    public static $info = [
        "route"         => "line_product_station.product.product_creation.step2_design.",
        "view"          => "line_product_station.product.product_creation.step2_design.",
        "enable_status" => [ "031" ],
        "priority_number" => 2001,
        "button"        => [ "caption" => "تایید گام 2 طراحی", "class" => "btn-primary" ],
        "message"       => [ "confirm" => "آیا تایید گام 2 طراحی اطمینان دارید؟" ],
        "button_id" => 5231033,
    ...
    public function submit( ProductCreationProcess $product_creation_process ) {
        ...
        return redirect()->route( $this->dashboard_path . "view", $product_creation_process )->with( [ "تایید گام 2 طراحی با موفقیت ثبت گردید" ] );
