...
{
    public static $info = [
        "route" => "line_product_station.product.product_creation.warehouse.",
        "view" => "line_product_station.product.product_creation.warehouse.",
        "enable_status" => ["006"],
        "priority_number" => 400,
        "button" => ["caption" => "تکمیل اطلاعات انبارش", "class" => "btn-primary"],
        "button_id" => 5231006,
    ...
    public function index(ProductCreationProcess $product_creation_process)
    {
        ...
        return \App\Http\Controllers\LineProductStation\Product\WarehouseController::GetIndex($product_creation_process->product, $this->view_path, $this->route_path, $product_creation_process);
    }
    ...
    public function submit(Request $request,Product $product, ProductCreationProcess $product_creation_process)
    {
        ...
        $result = \App\Http\Controllers\LineProductStation\Product\WarehouseController::PostSubmit($request, $product);
        if ($result["result"]) {
            ...
            event(new ProductCreationProcessLogEvent($product_creation_process, 5231009));
