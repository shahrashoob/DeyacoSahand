...
class WasteController extends Controller
{
    //
    public static $info = [
        "route" => "line_product_station.product.product_creation.waste.",
        "view" => "line_product_station.product.product_creation.waste.",
        "enable_status" => ["013"],
        "priority_number" => 1300,
        "button" => ["caption" => "ثبت  اطلاعات ضایعات", "class" => "btn-primary"],
        "button_id" => 5231016,
    ...
    public function submit(Request $request,Product $product, ProductCreationProcess $product_creation_process)
    {
        ...
        $result = \App\Http\Controllers\LineProductStation\Product\WasteController::PostSubmit($request, $product);
        if ($result["result"]) {
            ...
            event(new ProductCreationProcessLogEvent($product_creation_process, 5231017));
