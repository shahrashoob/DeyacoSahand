...
class ProductImageQuickController extends Controller
{
    // line_product_station/product.product_creation/product_image
    public static $info = [
        "route" => "line_product_station.product.product_creation.product_image_quick.",
        "view" => "line_product_station.product.product_creation.product_image_quick.",
        "enable_status" => ["503"],
        "priority_number" => 2000,
        "button" => ["caption" => " بارگذاری تصویر کالا (طراحی سریع)", "class" => "btn-primary"],
        "button_id" => 5231045,
