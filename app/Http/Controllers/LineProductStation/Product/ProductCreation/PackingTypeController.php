...
class PackingTypeController extends Controller
{
    //
    public static $info = [
        "route" => "line_product_station.product.product_creation.packing_type.",
        "view" => "line_product_station.product.product_creation.packing_type.",
        "enable_status" => ["015"],
        "priority_number" => 1700,
        "button" => ["caption" => "ثبت بسته بندی های مجاز کالا", "class" => "btn-primary"],
        "button_id" => 5231020,
    ...
    public function index(ProductCreationProcess $product_creation_process)
    {
        ...
        return \App\Http\Controllers\LineProductStation\Product\PackingTypeController::GetIndex($product_creation_process->product, $this->view_path, $this->route_path, $product_creation_process);
    }
    ...
    public function submit(Request $request,Product $product, ProductCreationProcess $product_creation_process)
    {
        ...
        $result = \App\Http\Controllers\LineProductStation\Product\PackingTypeController::PostSubmit($request, $product);
        if ($result["result"]) {
            ...
            event(new ProductCreationProcessLogEvent($product_creation_process, 5231019));
