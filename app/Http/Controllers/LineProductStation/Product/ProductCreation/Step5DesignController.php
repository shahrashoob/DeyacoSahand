...
class Step5DesignController extends Controller
{
    public static $info = [
        "route"         => "line_product_station.product.product_creation.step5_design.",
        "view"          => "line_product_station.product.product_creation.step5_design.",
        "enable_status" => [ "034" ],
        "priority_number" => 2004,
        "button"        => [ "caption" => "تایید گام 5 طراحی", "class" => "btn-primary" ],
        "message"       => [ "confirm" => "آیا تایید گام 5 طراحی اطمینان دارید؟" ],
        "button_id" => 5231036,
    ...
    public function submit( ProductCreationProcess $product_creation_process ) {
        ...
        event( new ProductCreationProcessLogEvent( $product_creation_process, 5231038 ) );

        return redirect()->route( $this->dashboard_path . "view", $product_creation_process )->with( [ "تایید گام 5 طراحی با موفقیت ثبت گردید" ] );
