...
class SaleController extends Controller
{
    //
    public static $info = [
        "route" => "line_product_station.product.product_creation.sale.",
        "view" => "line_product_station.product.product_creation.sale.",
        "enable_status" => ["005"],
        "priority_number" => 300,
        "button" => ["caption" => "تکمیل اطلاعات فروش", "class" => "btn-primary"],
        "button_id" => 5231005,
    ...
    public function submit(Request $request,Product $product, ProductCreationProcess $product_creation_process)
    {
        ...
        $result = \App\Http\Controllers\LineProductStation\Product\SaleController::PostSubmit($request, $product);
        if ($result["result"]) {
            ...
            event(new ProductCreationProcessLogEvent($product_creation_process, 5231008));
