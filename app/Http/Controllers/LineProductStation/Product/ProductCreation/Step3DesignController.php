...
class Step3DesignController extends Controller
{
    public static $info = [
        "route"         => "line_product_station.product.product_creation.step3_design.",
        "view"          => "line_product_station.product.product_creation.step3_design.",
        "enable_status" => [ "032" ],
        "priority_number" => 2002,
        "button"        => [ "caption" => "تایید گام 3 طراحی", "class" => "btn-primary" ],
        "message"       => [ "confirm" => "آیا تایید گام 3 طراحی اطمینان دارید؟" ],
        "button_id" => 5231034,
    ...
    public function submit( ProductCreationProcess $product_creation_process ) {
        ...
        event( new ProductCreationProcessLogEvent( $product_creation_process, 5231036 ) );

        return redirect()->route( $this->dashboard_path . "view", $product_creation_process )->with( [ "تایید گام 3 طراحی با موفقیت ثبت گردید" ] );
