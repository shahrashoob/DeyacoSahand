...
class SampleApprovalByCustomerController extends Controller
{
    public static $info = [
        "route" => "line_product_station.product.product_creation.sample_approval_by_customer.",
        "view" => "line_product_station.product.product_creation.sample_approval_by_customer.",
        "enable_status" => ["024"],
        "priority_number" => 2400,
        "button" => ["caption" => "تایید نمونه آزمایشگاهی توسط مشتری", "class" => "btn-primary"],
        "message" => ["confirm" => "آیا از تایید نمونه آزمایشگاهی اطمینان دارید؟"],
        "button_id" => 5231027,
    ...
    public function submit(Request $request,  ProductCreationProcess $product_creation_process)
    {
        ...
        event(new ProductCreationProcessLogEvent($product_creation_process, 5231029));
