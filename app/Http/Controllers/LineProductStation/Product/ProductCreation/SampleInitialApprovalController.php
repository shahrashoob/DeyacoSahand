...
class SampleInitialApprovalController extends Controller
{
    public static $info = [
        "route" => "line_product_station.product.product_creation.sample_initial_approval.",
        "view" => "line_product_station.product.product_creation.sample_initial_approval.",
        "enable_status" => ["021"],
        "priority_number" => 2100,
        "button" => ["caption" => "تایید اولیه نمونه (آزمایشگاهی)", "class" => "btn-primary"],
    ...
    public function submit(Request $request,  ProductCreationProcess $product_creation_process)
    {
        ...
        event(new ProductCreationProcessLogEvent($product_creation_process, 5231026));
