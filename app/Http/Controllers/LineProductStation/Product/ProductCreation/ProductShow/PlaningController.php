...
{
    public $route_path = "line_product_station.product.product_creation.product_show.planing.";
    public $view_path = "line_product_station.product.product_creation.product_show.planing.";
