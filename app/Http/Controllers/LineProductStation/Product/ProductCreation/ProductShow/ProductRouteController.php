...
class ProductRouteController extends Controller
{
    ...
    //
    private $route_path = "line_product_station.product.product_creation.product_show.route.";
    private $view_path = "line_product_station.product.product_creation.product_show.route.";
