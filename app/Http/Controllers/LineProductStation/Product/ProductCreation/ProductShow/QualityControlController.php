...
{
    public $route_path = "line_product_station.product.product_creation.product_show.quality_control.";
    public $view_path = "line_product_station.product.product_creation.product_show.quality_control.";
