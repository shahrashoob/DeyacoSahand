...
{// این قسمت مرتبط با تایید اولیه قرارداد هوشمند مشتری می باشد
    public static $info = [
        "route" => "hr.employment.admin.customer.drafting_contract_init.",
        "enable_status" => ["124"],
        "button" => ["caption" => "تایید اولیه پیش نویس قرارداد هوشمند (مشتری)", "class" => "btn-primary"],
        "view_path" => "hr.employment.admin.customer.drafting_contract_init.",
    ];
    var $view_path;
    var $route_path;
