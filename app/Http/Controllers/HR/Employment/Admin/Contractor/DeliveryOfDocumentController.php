...
{
    public static $info = [
        "route" => "hr.employment.admin.contractor.delivery_of_document.",
        "enable_status" => ["134"],
        "button" => ["caption" => "تایید تحویل قراداد (پیمانکار)", "class" => "btn-primary"],
        "view_path" => "",
        "message" => ["confirm" => "آیا از تایید تحویل قراداد پیمانکار اطمینان دارید؟"],
    ...
    public function submit(Employment $employment)
    {
        ...
        event(new EmploymentLogEvent($employment, 4640040));//تایید تحوبل مدارک
