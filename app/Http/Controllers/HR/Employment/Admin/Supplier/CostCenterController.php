...
class CostCenterController extends Controller
{
    ...
    protected $view_path = "hr.employment.admin.supplier.cost_center.";
    protected $route_path = "hr.employment.admin.supplier.cost_center.";
    ...
    public function store(Request $request, Employment $employment)
    {
        ...
        if (!$cost_center['result']) {
            ...
            return redirect()->route("hr.employment.admin.supplier.registration_cost_center.index", $employment)->with(["success" => "مرکز هزینه با موفقیت اضافه شد"]);
        }
    }
