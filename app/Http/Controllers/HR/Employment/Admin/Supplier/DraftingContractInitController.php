...
{
    public static $info = [
        "route" => "hr.employment.admin.supplier.drafting_contract_init.",
        "enable_status" => ["111"],
        "button" => ["caption" => " تایید اولیه پیش نویس قرارداد (تامین کننده)", "class" => "btn-primary"],
        "view_path" => "hr.employment.admin.supplier.drafting_contract_init.",
    ];
    var $view_path;
    var $route_path;
