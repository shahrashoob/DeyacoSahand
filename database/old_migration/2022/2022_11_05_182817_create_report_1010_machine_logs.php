...
class CreateReport1010MachineLogs extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('report_1010_machine_logs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('report_1010_machine_logs');
    }
}
