...
namespace Database\Seeders\GoodsKind\Fabric\SpecialProduction;

use App\Models\LineProduct\Machine\MachineModuleType;
use Illuminate\Database\Seeder;
use Illuminate\Support\Facades\DB;

class SpecialProductionSeeder extends Seeder {
    /**
     * Run the database seeds.
     * وضعیت های تولید ماشین در ماژول های تولید SpecialProduction
     * @return array[]
     */
    public static function getInfo() {
        return [
            7301 => [
                "caption"         => "کارت تولید",
                "status_type_id"  => 7301,
                "controller_info" => \App\Http\Controllers\GoodsKindProcess\Fabric\SpecialProduction\ProductionCard\DashboardController::get_controller_info_for_permission()
            ],
            7302 => [
                "caption"        => "فرم تولید",
                "status_type_id" => 7302,
                //   "controller_info" => \App\Http\Controllers\GoodsKindProcess\Warps\Dobby\ProductionForm\DashboardController::get_controller_info_all()
            ],
            7303 => [
                "caption"         => " ماشین ها",
                "status_type_id"  => 7303,
                "controller_info" => \App\Http\Controllers\GoodsKindProcess\Fabric\SpecialProduction\Machine\DashboardController::get_controller_info(),
                "code"            => [
                    7303001,
                    7303002,
                    7303003,
...
// این شناسه فقط برای ماشین استفاده می شود.
    ...
    public $machine_module_code = "special_production_fabric";
