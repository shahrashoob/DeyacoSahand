...
namespace Database\Seeders\GoodsKind\Warps\Matthys;

use App\Models\LineProduct\Machine\MachineModuleType;
use Illuminate\Database\Seeder;
use Illuminate\Support\Facades\DB;

class MatthysSeeder extends Seeder {
    /**
    ...
    public static function getInfo() {
        return [
            7201 => [
                "caption"         => "کارت تولید",
                "status_type_id"  => 7001,
                "controller_info" => \App\Http\Controllers\GoodsKindProcess\Warps\Matthys\ProductionCard\DashboardController::get_controller_info_for_permission()
            ],
            7202 => [
                "caption"        => "فرم تولید",
                "status_type_id" => 7052,
            ...
            7203 => [
                "caption"         => " ماشین ها",
                "status_type_id"  => 7003,
                "controller_info" => \App\Http\Controllers\GoodsKindProcess\Warps\Matthys\Machine\DashboardController::get_controller_info(),
                "code"            => [
                    7203001,
                    7203002,
                    7203003,
...
// این شناسه فقط برای ماشین استفاده می شود.
    ...
    public $machine_module_code = "matthys";
