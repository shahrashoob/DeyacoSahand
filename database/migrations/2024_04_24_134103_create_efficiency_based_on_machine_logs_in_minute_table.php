...
return new class extends Migration
{
    ...
    {
        Schema::create('efficiency_based_on_machine_logs_m', function (Blueprint $table) {
            $table->id();
            ...
            $table->bigInteger("created_minute_number")->index()->comment("عدد زمان (دقیقه)");
            ...
            $table->bigInteger("created_month_number")->index()->comment("عدد زمان (ماه)");
    ...
    {
        Schema::dropIfExists('efficiency_based_on_machine_logs_in_minute');
    }
};
