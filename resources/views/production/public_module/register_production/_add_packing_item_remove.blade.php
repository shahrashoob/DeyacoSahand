...
<div class="col-md-12" style="text-align: center">
    ...
    <div class="btn-group mb-2 mr-2">
        ...
        <a class="btn btn-outline-dark" style="width: 140px"
           href="{{route("contractor.panel.register_production.index",[$machine_allocation])}}">
...
<script>
    ...
    window.location.href = ("{{route("contractor.panel.register_production.index",[$machine_allocation])}}");
    ...
    function add_new_product(check_gross_weight=false) {
        ...
        @if($get_gross_weight)
        if (check_gross_weight && isNaN(parseFloat(gross_weight))) {
            alert("لطفا وزن کل را وارد نمایید.")
            return 0;
        }
        if (check_gross_weight && parseFloat(gross_weight) <= 0) {
