    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>  کنسل کردن کارت تولید {{$production->serial()}}</h5>
            </div>
            <div class="card-block">
                <form id="form1" action="{{route("production.dashboard.submit_cancel",$production)}}" method="post" novalidate="novalidate">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                @include("component.input._textarea",["id"=>"description","label"=>"دلیل کنسل کردن کارت  ","value"=>""])
                              </div>
                        </div>
