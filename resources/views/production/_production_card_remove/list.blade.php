...
@section("content")
    <div class="row">
        ...
        <div class="col-sm-12">
            @include("production.production_card._search_view",["route"=>"production.list"])
            <div class="card">
                <div class="card-header">
                    <h5>لیست کارت های در انتظار تولید</h5>
                </div>
                        ...
                        <table class="table table-styling">
                            ...
                            @foreach($list as $item)
                                <tr>
                                    <td>{{$row++}}</td>
                                    <td>
                                        <a href="{{route("production.view_card",$item->production_card_id)}}">{{$item->serial(1)}}</a>
                                    </td>
