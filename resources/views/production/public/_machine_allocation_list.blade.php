            ...
            <div class="card-block">
                ...
                <div class="table-responsive">
                    <table class="table table-styling" style="text-align: center">
                        ...
                        <tbody>
                        @php $row=1;@endphp
                        @php $allow_cancel_card= $post_user->checkButtonPermission($goods_kind_caption.".allocation_cancel.index");@endphp
                            ...
                            <tr>
                                ...
                                <td>
                                    @if( $allow_cancel_card)
                                        <a href="{{route($goods_kind_caption.".allocation_cancel.index",[$item->allocation_id,$item->production_id])}}"
                                           onclick="return confirm('آیا از کنسل کردن تخصیص اطمینان دارید؟');"><i
