...
@section('content')
    <div class="row">
        ...
        <div class="col-md-12 center">
            ...
            @if ( $form->status_id == 500000710 && $post_user->checkButtonPermission( "guarding.dashboard.show_form" ))
                <form id="form1" autocomplete="off"
                      action="{{route("guarding.dashboard.confirm_input_form",[$form])}}"
                      method="post"
                ...
                <button type="submit" class="btn btn-primary"
                        onclick="return confirm('آیا از تایید فرم ورود اطمینان دارید؟')">ثبت ورود
                    (نگهبانی)
                </button>

                <a href="{{route("guarding.dashboard.reject_input_form",[$form])}}" type="submit" class="btn btn-danger"
