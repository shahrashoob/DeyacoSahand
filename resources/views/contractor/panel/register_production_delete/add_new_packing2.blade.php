            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form id="form1" autocomplete="off"
                        ...
                        <div class="col-md-12">
                            @if(isset($packing_form) && $packing_form->parent_packing_form_sub_packing())
                            ...
                            @endif
                                ...
                                <div class="btn-group mb-2 mr-2">
                                    <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ثبت</button>
                                    <div class="dropdown-menu" style="text-align: center">
                                        <a class="dropdown-item" href="#!">ثبت ، چاپ و ادامه</a>
                                        <a class="dropdown-item" href="#!">ثبت ، چاپ و بازگشت</a>
                                        <a class="dropdown-item" href="#!">ثبت و ادامه</a>
                                        <a class="dropdown-item" href="#!">ثبت و بازگشت</a>
                                    </div>
                                </div>
