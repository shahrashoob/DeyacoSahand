        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5> افزودن رسته کالای جدید </h5>
                </div>
                <div class="card-block">

                    <form id="form1" action="{{route("line_product_station.goods_kind.store")}}" method="post"
                          autocomplete="off"
...
"value"=>$goods_kind->allowed_percentage_in_complete_form_information])
                            ...
                            <div class="w-100"></div>
                            <div class="col-md-6">
                                @include("component.input._checkbox",["id"=>"required_parent_production",'label'=>"اجباری بودن ثبت سریال کارت تولید سطح بالا و بررسی قابلیت فروش","checked"=>$goods_kind->required_parent_production??0])
                            </div>
                            <div class="w-100"></div>
                            <div class="col-md-6">
                                @include("component.input._checkbox",["id"=>"checking_compatibility_grade_in_delivery",'label'=>"بررسی انطباق درجه درخواست شده کالا از انبار با درجه تحویلی کالا","checked"=>$goods_kind->checking_compatibility_grade_in_delivery??0])
                            </div>
                            <div class="w-100"></div>
                            <div class="col-md-6">
                                @include("component.input._checkbox",["id"=>"possibility_of_issuing_a_production_manually",'label'=>"امکان صدور برگ دستور تولید به صورت دستی برای کالاهای رسته کالایی","checked"=>$goods_kind->possibility_of_issuing_a_production_manually??0])
                            </div>
                            <div class="w-100"></div>
                            <div class="col-md-6">
                        ...
                        <button type="submit" class="btn btn-primary"> ثبت رسته کالایی جدید</button>
