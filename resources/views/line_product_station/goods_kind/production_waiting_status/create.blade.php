        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5> افزودن وضعیت جدید </h5>
                </div>
                <div class="card-block">

                    <form id="form1" action="{{route("production.waiting_status.store",$goods_kind)}}" method="post"
                          autocomplete="off"
                        ...
                        <a href="{{route("production.waiting_status.index",$goods_kind)}}" class="btn btn-outline-dark">بازگشت</a>
