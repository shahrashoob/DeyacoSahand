        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>افزودن مشخصه جدید به  {{$goods_kind->caption}}
                    </h5>
                </div>
                <form id="form1" action="{{route("line_product_station.goods_kind.property.store",[$goods_kind])}}"
                      method="post"
                      autocomplete="off"
                    ...
                    <div class="card-block">
                        <div class="row">
                            @include("component.input._text",["id"=>"caption",'label'=>"عنوان مشخصه "])
                            ...
                            @include("component.input._number",["id"=>"priority_number",'label'=>"اولویت نمایش ","value"=>1])
                        </div>
