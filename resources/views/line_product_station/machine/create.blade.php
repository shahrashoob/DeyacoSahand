        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5> افزودن ماشین(های) جدید گروه {{$machine_type->caption}}</h5>
                </div>
                <div class="card-block">

                    <form id="form1" action="{{route("line_product_station.machine.store",$machine_type)}}" method="post"
                          autocomplete="off"
                        ...
                        <button type="submit" class="btn btn-primary"> افزودن ماشین(ها)</button>
