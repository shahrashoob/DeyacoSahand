        ...
        <div class="col-sm-12">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                @if($product->product_service_type_id == 1)
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{$tab=="quality_control"?"active":""}} text-uppercase" id="quality_control-tab"
                           data-toggle="tab" href="#quality_control"
                           role="tab"
                           aria-controls="quality_control" aria-selected="false">کنترل کیفیت</a>
                    </li>


                    <li class="nav-item">
                        <a class="nav-link {{$tab=="planing"?"active":""}} text-uppercase" id="planing-tab"
            ...
            <div class="tab-content " id="myTabContent">
                <div class="tab-pane fade {{$tab=="edit"?"show active ":""}}  " id="home" role="tabpanel"
                    ...
                    @if($tab=="edit")
                        @include("line_product_station.product.product_creation.product_show._init_info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>

                <div class="tab-pane fade {{$tab=="supplementary"?"show active ":""}}  " id="edit_supplementary" role="tabpanel"
                     aria-labelledby="edit_supplementary-tab">
                    @if($tab=="supplementary")
                        @include("line_product_station.product.product_creation.product_show.supplementary._info")
                    @else
                ...
                <div class="tab-pane fade {{$tab=="sales"?"show active ":""}}" id="sales" role="tabpanel"
                    ...
                    @if($tab=="sales")
                        @include("line_product_station.product.product_creation.product_show.sale._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.sale.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                ...
                <div class="tab-pane fade {{$tab=="edit_classification"?"show active ":""}}" id="contact-classification"
                    ...
                    @if($tab=="edit_classification")
                        @include("line_product_station.product.product_creation.product_show.classification._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.classification.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                ...
                <div class="tab-pane fade {{$tab=="edit_property"?"show active ":""}}" id="contact" role="tabpanel"
                    ...
                    @if($tab=="edit_property")
                        @include("line_product_station.product.product_creation.product_show.property._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.property.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>
                <div class="tab-pane fade {{$tab=="warehouse"?"show active ":""}}" id="contact5" role="tabpanel"
                    ...
                    @if($tab=="warehouse")
                        @include("line_product_station.product.product_creation.product_show.warehouse._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.warehouse.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>
                <div class="tab-pane fade  {{$tab=="consumed"?"show active ":""}}" id="consumed" role="tabpanel"
                    ...
                    @if($tab=="consumed")
                        ...
                        @include("line_product_station.product.product_creation.product_show.consumed_product._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.consumed_product.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>
                <div class="tab-pane fade  {{$tab=="product_route"?"show active ":""}}" id="route" role="tabpanel"
                    ...
                    @if($tab=="product_route")
                        ...
                        @include("line_product_station.product.product_creation.product_show.route._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.route.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>
                <div class="tab-pane fade  {{$tab=="route_property"?"show active ":""}}" id="route_property"
                    ...
                    @if($tab=="route_property")
                        ...
                        @include("line_product_station.product.product_creation.product_show.route_property._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.route_property.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>
                ...
                <div class="tab-pane fade {{$tab=="edit_replace_product"?"show active ":""}}" id="province2"
                    ...
                    @if($tab=="edit_replace_product")
                        @include("line_product_station.product.product_creation.product_show.replace_product._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.replace_product.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>
                ...
                <div class="tab-pane fade {{$tab=="product_bom"?"show active ":""}}" id="channel" role="tabpanel"
                    ...
                    @if($tab=="product_bom")
                        @include("line_product_station.product.product_creation.product_show.bom._info")
                    @else
                ...
                <div class="tab-pane fade {{$tab=="bom_permutation"?"show active ":""}}" id="bom_permutation"
                    ...
                    @if($tab=="bom_permutation")
                        @include("line_product_station.product.product_creation.product_show.bom_permutation._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.bom_permutation.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>
                ...
                <div class="tab-pane fade {{$tab=="waste"?"show active ":""}}" id="waste" role="tabpanel"
                     aria-labelledby="channel-tab">
                    @if($tab=="waste")
                        @include("line_product_station.product.product_creation.product_show.waste._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.waste.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>
                ...
                <div class="tab-pane fade {{$tab=="edit_lot_number"?"show active ":""}}" id="edit_lot_number"
                    ...
                    @if($tab=="edit_lot_number")
                        @include("line_product_station.product.product_creation.product_show.lot_number._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.lot_number.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>
                <div class="tab-pane fade {{$tab=="shade_number"?"show active ":""}}" id="shade_number"
                    ...
                    @if($tab=="shade_number")
                        @include("line_product_station.product.product_creation.product_show.shade_number._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.shade_number.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>
                ...
                <div class="tab-pane fade {{$tab=="edit_product_type"?"show active ":""}}" id="edit_product_type"
                    ...
                    @if($tab=="edit_product_type")
                        @include("line_product_station.product.product_creation.product_show.packing_type._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.packing_type.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>
                ...
                <div class="tab-pane fade {{$tab=="quality_control"?"show active ":""}}" id="quality_control"
                    ...
                    @if($tab=="quality_control")
                        @include("line_product_station.product.product_creation.product_show.quality_control._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.quality_control.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>
                ...
                <div class="tab-pane fade {{$tab=="planing"?"show active ":""}}" id="planing"
                    ...
                    @if($tab=="planing")
                        @include("line_product_station.product.product_creation.product_show.planing._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.planing.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>
                <div class="tab-pane fade {{$tab=="edit_material_flow"?"show active ":""}}" id="edit_material_flow"
                    ...
                    @if($tab=="edit_material_flow" && isset($info))
                        @include("line_product_station.product.product_creation.product_show.material_flow._".$info)
                    @elseif($tab=="edit_material_flow")
                        @include("line_product_station.product.product_creation.product_show.material_flow._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.material_flow.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>
{{--                قیمت گذاری--}}
                <div class="tab-pane fade {{$tab=="pricing"?"show active ":""}}" id="pricing"
                    ...
                    @if($tab=="pricing")
                        @include("line_product_station.product.product_creation.product_show.pricing._info")
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.pricing.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>
{{--                ورژن کالا --}}
                <div class="tab-pane fade {{$tab=="version"?"show active ":""}}" id="version"
                    ...
                    @else
                        <a href="{{route("line_product_station.product.product_creation.product_show.version.index",$product_creation_process)}}"
                           class="btn btn-primary"><i class="fa fa-undo"></i> بارگذاری </a>
                    @endif
                </div>
