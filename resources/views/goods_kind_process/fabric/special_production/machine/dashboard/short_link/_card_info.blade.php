<table style="">
    ...
    <tr>
        <td colspan="3">
            ...
            <a href="{{route("fabric_raw.jacquard.machine.allocation_card.index",[$machine,$machine_allocation->allocation])}}"  class="print" style="float: left; padding-left: 5px"><i class="fa fa-print"></i> چاپ </a>
