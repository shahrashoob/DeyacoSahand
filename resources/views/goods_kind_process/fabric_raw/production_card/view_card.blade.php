...
{{--        @include("goods_kind_process.fabric_raw.production_card.public.log_status")--}}
        ...
        @include("production.public._machine_re_allocation_list",["goods_kind_caption"=>"fabric_raw"])

        @include("production.public._machine_allocation_list",["goods_kind_caption"=>"fabric_raw"])
        @include("production.public._production_form_list",["goods_kind_caption"=>"fabric_raw"])
