...
@section('content')
    <form id="form1" action="{{route("fabric_raw.machine_allocation.select_band_submit",[$machine,$production])}}" method="post"
        ...
        <div class="row">
                        ...
                        <div class="card-block border-bottom">
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col">
                                    ...
                                    <span class="d-block text-uppercase">{{$production->serial()}} - {{$production->product->caption}}  <b></b></span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-sm-12" style="text-align: center">
                ...
                <a href="{{route("fabric_raw.dashboard.view_card",$production)}}" class="btn btn-outline-dark">بازگشت
                    به کارتابل تولید</a>
            </div>
