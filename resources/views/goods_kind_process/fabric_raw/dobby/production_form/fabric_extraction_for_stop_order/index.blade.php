        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    <form id="form1" action="{{route("fabric_raw.production_form.fabric_extraction_for_stop_order.submit",$production_form)}}"
                          method="post"
                          autocomplete="off"
                        ...
                        <div class="col-md-12">
                            <a href="{{route("fabric_raw.production_form.dashboard.view",$production_form)}}" class="btn btn-outline-dark">بازگشت</a>
