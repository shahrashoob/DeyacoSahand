        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    <form id="form1" action="{{route("fabric_raw.machine.begin_intro_change_lot.submit",$machine)}}"
                          method="post"
                          autocomplete="off"
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="submit" class="btn btn-success">تایید شروع مقدمات کالیته</button>
                        </div>
