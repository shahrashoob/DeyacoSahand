        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>پایان تغییر لات نخ پود (دستور توقف)   {{$machine->getCode()}} - {{$machine->caption}}</h5>
                </div>
                <div class="card-block">
                    <form id="form1" action="{{route("fabric_raw.machine.end_of_change_yarn_for_stop_order.submit",$machine)}}"
                          method="post"
                          autocomplete="off"
