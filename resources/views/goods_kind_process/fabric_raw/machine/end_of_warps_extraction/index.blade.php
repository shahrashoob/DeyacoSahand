        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>   پایان  استخراج چله   {{$machine->getCode()}} - {{$machine->caption}}</h5>
                </div>
                <div class="card-block">
                    <form id="form1" action="{{route("fabric_raw.machine.end_of_warps_extraction.submit_type2",$machine)}}"
                          method="post"
                          autocomplete="off"
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="submit" class="btn btn-success">تایید  پایان  استخراج چله</button>
                        </div>
