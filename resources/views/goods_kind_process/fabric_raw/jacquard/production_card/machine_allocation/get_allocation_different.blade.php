...
@section("content")
    <div class="row">
        ...
        <div class="col-sm-12 ">
            ...
            <div class="card">
                <div class="card-header">
                    <h5> آیا طرح  در تخصیص جدید تغییر خواهد کرد؟

                    </h5>
                    <h3 style="color: #EE5757 ; display: inline"> {{$value["has_article_change"]?"بله":"خیر"}}</h3>
                </div>
                    ...
                    <div class="card-block">
                        <div class="table-responsive">
                            <table class="table table-styling center ">
                                ...
                                @foreach($value["article_caption"] as $key=>$caption)
                                    <tr
                                        class=" {{ (isset($value["before_article_value_product"][$key])?$value["before_article_value_product"][$key]:"-") !=
                                      (isset($value["current_article_value_product"][$key])?$value["current_article_value_product"][$key]:"-") ?"alert-warning":"-"}}"
                                    ...
                                    >
                                        ...
                                        <td>
                                            {{isset($value["before_article_value_product"][$key])?$value["before_article_value_product"][$key]:"---"}}
                                        </td>
                                        <td>
                                            {{isset($value["current_article_value_product"][$key])?$value["current_article_value_product"][$key]:"---"}}
                                        </td>
                                    </tr>
                                @endforeach
        ...
        <div class="col-sm-12 ">
            ...
            <div class="card">
                <div class="card-header">
                    <h5> آیا عرض شانه ماشین در تخصیص جدید تغییر خواهد کرد؟

                    </h5>
                    <h3 style="color: #EE5757 ; display: inline"> {{$value["has_bar_fabric_change"]?"بله":"خیر"}}</h3>
                </div>
                @if(isset($value["property_caption"]))
                    <div class="card-block">
                        <div class="table-responsive">
                            <table class="table table-styling center ">
                                ...
                                <tr>
                                    ...
                                    <tr
                                        class=" {{ (isset($value["before_bar_fabrice"])?$value["before_bar_fabrice"]:"-") !=
                                      (isset($value["current_bar_fabrice"])?$value["current_bar_fabrice"]:"-") ?"alert-warning":"-"}}"
                                    ...
                                    >
                                        ...
                                        <td>
                                            {{isset($value["before_bar_fabrice"])?$value["before_bar_fabrice"]:"---"}}
                                        </td>
                                        <td>
                                            {{isset($value["current_bar_fabrice"])?$value["current_bar_fabrice"]:"---"}}
                                        </td>
                                    </tr>
        ...
        <form id="form1" action="{{route("fabric_raw.jacquard.machine_allocation.confirm_submit",[$allocation->machine])}}" method="post"
            ...
            <div class="col-sm-12" style="text-align: center">
                ...
                <a href="{{route("fabric_raw.production_card.view_card",$allocation->items[0]->production)}}" class="btn btn-outline-dark">بازگشت
                    به کارتابل تولید</a>
            </div>
        </form>
@endsection
