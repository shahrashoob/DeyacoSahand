...
@section("content")
    <div class="row">
        ...
        <div class="col-sm-12">
            @include("line_product_station.machine.public._search_view",["route"=>"fabric_raw.machine.dashboard.index"])
            <div class="card">
                        ...
                        <table class="table table-styling" style="text-align: center!important;">
                            ...
                            @foreach($list as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route("fabric_raw.machine.dashboard.view",$item)}}">{{$item->code}}
                                            - {{$item->caption}}</a>
                                    </td>
