        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5> پایان راه اندازی شیفت {{$machine->getCode()}} - {{$machine->caption}}</h5>
                </div>
                <div class="card-block">
                    <form id="form1"
                          action="{{route("fabric_raw.jacquard.machine.end_of_launch.submit",$machine)}}"
                          method="post"
                          autocomplete="off"
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="submit" class="btn btn-success">ثبت  پایان راه اندازی شیفت</button>
                        </div>
