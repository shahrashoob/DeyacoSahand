            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <div class="table-responsive">
                        ...
                        @include("component.input._lable",["id"=>"","lable"=>$product_unit->measurement." کل ","value"=>$packing_form->getAmount()." ".$product_unit->caption,"class_col"=>"col-md-12"])
                        @include("component.input._lable",["id"=>"","lable"=>$product_unit->measurement." کل نهایی  ","value"=>$sum_final_amount_bands." ".$product_unit->caption,"class_col"=>"col-md-12"])
                        @include("component.input._lable",["id"=>"","lable"=>"درصد جمع شدگی ","value"=>$packing_form->final_shrinkage_percent($sum_final_amount_bands)." % ","class_col"=>"col-md-12"])


                        <form id="form1"
                              action="{{route("fabric_raw.packing_form.change_packing.submit_section",[$packing_form,$packing_item->band_code])}}"
                              method="post"
                              autocomplete="off"
                            ...
                            @if( $latest_packing_item_temp->final_amount+ $latest_packing_sum_before < $sum_final_amount )
                                <div class="row alert alert-info"
                                    ...
                                    @include("component.input._number",["id"=>"end_point","class_col"=>"col-md-3 col-xs-12","autofocus"=>1,"label"=>" از متراژ ".$latest_packing_sum_before." تا متراژ ","value"=>""])
                                    ...
                                    @if($has_number_ability)
                                        @for($k=0;$k<$max_carrier;$k++)
                                            @include("component.input._number",["id"=>"carrier_id_$k","class_col"=>"carrier_div_$k carrier col-md-3 col-xs-12","autofocus"=>1,"label"=>"حامل","value"=>""])
                                            @include("component.input._number",["id"=>"band_carrier_id_$k","class_col"=>"band_carrier_div_$k carrier col-md-3 col-xs-12","label"=>"باند","value"=>"1"])
                                        @endfor
                                    @endif
                                    @include("component.input._select",["id"=>"new_carrier_id","class_col"=>"new_carrier_div carrier col-md-3 col-xs-12","autofocus"=>1,"label"=>"آیا بسته بندی جدید است؟","option"=>$option])
                        ...
                        @if(  round($latest_packing_sum_before ,6)==round( $sum_final_amount,6))
                            @if(isset($final_amount_list[$packing_item->band_code+1])  )
                                ...
                                <div class="col-md-12" style="text-align: center">
                                    ...
                                    <a href="{{route("fabric_raw.packing_form.change_packing.section",[$packing_form,$band_code+1])}}"
                            ...
                            @else
                                ...
                                <div class="col-md-12" style="text-align: center">
                                    <form id="form1"
                                          action="{{route("fabric_raw.packing_form.change_packing.end_of_section",$packing_form)}}"
                                          method="post"
                                          autocomplete="off"
                                          novalidate="novalidate">
                                        @csrf
                        ...
                        <div class="col-md-12 center">
                            <br/>
                            <br/>
                            <a href="{{route("fabric_raw.packing_form.change_packing.index",$packing_form)}}"
