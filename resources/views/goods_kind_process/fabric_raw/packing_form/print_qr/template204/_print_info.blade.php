        ...
        <tr>
            <td style="border-top: none;padding-right: 3px;">
                <table style="border: none">
                    ...
                    <tr>
                        <td colspan="2" style="border: none; text-align: right; font-size: 10px;padding-right: 3px;">

                            کد کالا:
                            {{$packing_form->items->first()->product->code}}
                            <br/>
                            شماره بسته بندی: {{$packing_form->getCode()}}  <br/>
                    ...
                    <tr>
                        <td colspan="2" style="border: none; text-align: right; font-size: 11px;padding-right: 3px;text-align: center">

                            <span style="font-size: 55px; display: inline; font-weight: bold">
