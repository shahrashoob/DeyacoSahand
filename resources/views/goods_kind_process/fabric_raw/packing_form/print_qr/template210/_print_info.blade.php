...
کد کالا:
                    ...
                    <tr>
                        <td style="border: none; text-align: right; font-size: 11px; line-height: 16px; padding-bottom: 2px">
                            ...
                            <table style="border: none;">
                                <tr>
                                    <td style="border: none;font-size: 15px;text-align: right">
                                        ...
                                        @if($packing_form->items->first() && isset($packing_form->items->first()->production_form_item->production->order) && $packing_form->items->first()->production_form_item->production->order)
                                            ...
                                            {{$packing_form->items->first()->production_form_item->production->order->customer->detailed_code}}
                                        @endif

                                    </td>
                                    <td style="border: none;text-align: right;font-size: 15px;">
                               ...
                               <tr>
                                ...
                                <td style="border: none;font-size: 15px;text-align: right">
                                    ...
                                    نوع بسته بندی:
                                    {{$packing_form->packing_type->code}}
                ...
                <table style="border: none; text-align: right;">
                    <tr>
                        ...
                        <td style="font-size: 12px;border: none; text-align: center;">
                                        <span style="font-size: 25px; display: inline; font-weight: bold">
