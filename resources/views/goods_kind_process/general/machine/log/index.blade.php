...
@section("content")
    <div class="row">
        ...
        <div class="col-sm-12">
            @include("goods_kind_process.general.machine.log._search",["route"=>$route_path."index"])
                            ...
                            @foreach($list as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($item->station_sub_operation)
                                            <br/>
                                            ({{$item->station_sub_operation->station_operation->caption."/".$item->station_sub_operation->caption}})
                                        @endif
                                    </td>
                                    <td>
