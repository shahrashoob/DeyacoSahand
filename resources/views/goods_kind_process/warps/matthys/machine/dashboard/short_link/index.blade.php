    ...
    <div class="row" style="overflow: auto">
        ...
        @if($current_allocation)
            <div class=" current col-md-6" style="margin: auto">
                @include("goods_kind_process.warps.matthys.machine.dashboard.short_link._card_info",["machine_allocation"=>$current_machine_allocation,"caption"=>"تخصیص جاری ماشین"])
            </div>
            <div class="w-100"></div>
        @endif
    </div>
        ...
        @if( count($reserve_allocation_list) > 0)
            @foreach($reserve_allocation_list as $machine_allocation)
                <div class=" reserve col-md-6" style="margin: auto">
                    @include("goods_kind_process.warps.matthys.machine.dashboard.short_link._card_info",["machine_allocation"=>$machine_allocation,"caption"=>"تخصیص رزرو ماشین"])
                </div>
                <div class="w-100"></div>
            @endforeach
