...
@section('content')
    <form id="form1" action="{{route("warps.karl_mayer.machine_allocation.confirm_submit",[$machine,$production])}}"
          method="post"
        ...
        <div class="row">
                        ...
                        <div class="card-block border-bottom">
                            <div class="row d-flex align-items-center">
                                @foreach($production->packing_types as $production_packing_type)
                                    ...
                                    <div class="col">
                                        <h3 class="f-w-300"></h3>
                                        @include("component.input._number",["id"=>"packing_type_doff_number[".$production_packing_type->packing_type_id."]","label"=>"تعداد داف از ".$production_packing_type->packing_type->caption,"class_col"=>"col-md-12","value"=>"" ])
            ...
            <div class="col-sm-12" style="text-align: center">
                ...
                <a href="{{route("warps.production_card.view_card",$production)}}" class="btn btn-outline-dark">بازگشت
                    به کارتابل تولید</a>
            </div>
