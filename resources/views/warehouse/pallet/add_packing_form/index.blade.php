    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>افزودن بسته بندی به پالت {{$pallet->code}}</h5>
                </div>
        ...
        <div class="col-md-12 center" id="btn_submit">
            ...
            <a type="submit" class="btn btn-primary submit_form"
               href="{{route("wh.pallet.add_packing_form.show_list",$pallet)}}"> تایید و
                ادامه</a>
        </div>
...
@section("scripts")
   @include("component.read_packing_form._script",["message_type_id"=>400])
@endsection
