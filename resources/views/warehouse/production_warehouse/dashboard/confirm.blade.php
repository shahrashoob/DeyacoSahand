        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    <form id="form1"
                          action="{{route($route_path."submit_confirm",[$form,$product_request_form,$warehouse])}}"
                          method="post" autocomplete="off" novalidate="novalidate"> @csrf
                        @include("warehouse.production_warehouse.dashboard._confirmation_view",["dashboard_url"=>route($dashboard_route."index")])
                    </form>
                </div>
            </div>
        </div>
