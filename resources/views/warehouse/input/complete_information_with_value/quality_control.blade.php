...
@section('content')
    ...
    <div dir="rtl" class="container  card ">

        <div class="card-header">
            <h5> کنترل گرماژ برای {{$form_general_item->product->caption}}</h5>
        </div>
        <div class="card-block">
            ...
            <div class="row">
                ...
                <div class="col-md-12" id="complete_with_valueView">
                    ...
                    @include("warehouse.input.complete_information_with_value._quality_control_input_value")</div>
