...
@section('content')
    ...
    <form id="form1" autocomplete="off" action="{{route("wh.input.entry_form.submit2")}}"
          method="post"
        ...
        <div class="row">
            ...
            <div class="col-md-12" id="card-block">
                @include("warehouse.input.entry_form._packing_form_rows2")
            </div>
...
@section("scripts")
    @include("warehouse.input.entry_form._script2")
    <script>
        $('#form1').validate({
            rules: {
                "product_id": "required",
