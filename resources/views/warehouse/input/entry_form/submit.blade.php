...
@section('content')
    ...
    <form id="form1" autocomplete="off" action="{{route("wh.input.entry_form.confirm")}}"
          method="post"
                                ...
                                <table class="table table-styling">
                                    ...
                                    @foreach(json_decode($packing_form_rows) as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" min="0" max="100" name="packing_form_copy[{{$row}}]" value="1" style="width: 60px">
                                            </td>
                                        </tr>
                                    @endforeach
