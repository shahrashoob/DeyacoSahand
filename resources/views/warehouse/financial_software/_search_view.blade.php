    ...
    <div class="card-block">
        ...
        <form action="{{route($route)}}" method="post">
            <div class="row">
                ...
                <div class="col-md-2">
                    @include("component.input._aotocomplet",[
                        "id"=>"financial_status_id",
                        "label"=>" فیلتر (وضعیت فرم انتقال) ",
                        "text_white"=>1,
                        "option"=>$financial_status_id_option["items"],
                        "val"=>$financial_status_id_option["value"],
                        "text"=>$financial_status_id_option["text"],
                        ])
                </div>
                <div class="col-md-2">
                    @include("component.input._aotocomplet",[
