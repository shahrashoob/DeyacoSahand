        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form id="form1"
                          action="{{route("wh.out.dashboard.confirm_variety_1",$product_request_form_item)}}"
                          method="post"
                          autocomplete="off"
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table table-styling center" style="">
                                        ...
                                        <tbody>
                                        @php $row=0;@endphp
                                        @php $amount -= $product_request_form_item->amount_remaining; @endphp
                                        ...
                                        @foreach($product_request_form_item_list as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif(count($product_request_form_item_list) > $row)
                                                        {{min($item->amount_remaining, $amount)}}
                                                        @php $amount -= $item->amount_remaining; @endphp
                                                    @else
                                                        {{$amount}}
