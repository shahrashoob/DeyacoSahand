<div class="content">
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            @php $sub_unit_measurement=$packing_form->getUnitCaption("sub_unit","measurement");@endphp
            <th   @if($sub_unit_measurement=="") style="width: 0px" @endif>
