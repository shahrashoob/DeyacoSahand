            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <div class="alert alert-warning">
                        با توجه به اینکه بسته بندی انتخاب شده شامل کالاهای دیگری به غیر از کالای در حال تحویل می باشد،
                    ...
                    <form id="form1"
                          action="{{route("wh.out.delivery.submit_select_amount_of_product_request_form",$product_request_form)}}"
                          method="post"
                          autocomplete="off"
                                    ...
                                    <table class="table table-styling center" style="">
                                        ...
                                        @foreach($product_request_form_item_list as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <input style="text-align: center; width: 100px" type="text" name="data[product_request_form_item][{{$item->id}}]"
                                                           value="{{$packing_form_final_amount_list[$item->product_id]}}">

                                                    @php $packing_form_final_amount_list[$item->product_id]=0;@endphp
                                                </td>
                        ...
                        <div style="text-align: center">
                            <a href="{{route("wh.out.dashboard.index",$product_request_form)}}"
