        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5> فرم تحویل کالا از انبار - کد {{$product_request_form->getCode()}} </h5>
                </div>

                <div class="card-block">
                    <form id="form1" action="{{route("wh.out.dashboard.delivery",$product_request_form)}}"
                          method="post"
                          autocomplete="off"
                        ...
                        <div class="row">
                            ...
                            @foreach($product_request_form->items as $item)
                                ...
                                @if($product_request_form->status_id == "7005001" || $product_request_form->status_id == "7005005")
                                    @include("component.input._aotocomplet2",[
                                        "id"=>"warehouse_product_id_".$item->id,
                                        "label"=>("انتخاب حامل برای ".$item->product->caption??"")." (خط ورودی ".$item->input_line_code.")",
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        @foreach($item->product_request_form_packing_types as $product_packing_item)
