        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form id="form1"
                          action="{{route("wh.out.delivery.confirm",[$product_request_form,$page])}}"
                          method="post"
                          autocomplete="off"
...
<div class="alert alert-warning">
    با توجه به اینکه تعداد اقلام بسته بندی بیش از حد مجاز است، امکان ثبت تحویل به صورت آنی وجود ندارد، در صورت تایید بعد از
    <h6 style="display: inline">
        {{$time}}
        دقیقه
    </h6>
      فرم ورود خروج ثبت و تایید می گردد.
</div>
                            </div>
...
@section("scripts")
    <script>
        $("#btn_confirm_print1").click(function () {
            $("#print").val("print_1");
            $("#form1").submit();
        })
        $("#btn_confirm_print3").click(function () {
            $("#print").val("print_3");
            $("#form1").submit();
        })
        $("#btn_confirm_print4").click(function () {
            $("#print").val("print_4");
            $("#form1").submit();
        })
