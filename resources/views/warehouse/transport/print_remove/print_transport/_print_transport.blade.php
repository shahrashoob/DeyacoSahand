<div class="content" style="border: #0b0b0b 3px solid; padding:3px">
    <div style="text-align: center; padding: 3px">
        {{$header_text}}
        <br/>
        گزارش بسته بندی درخواست به تفکیک بسته بندی حمل و نقل
    ...
    <table style="width: 100%; border:none">
        ...
        <tr>
            ...
            <td style="border:none">تعداد بسته بندی حمل و نقل:
                {{$product_request_form->transport_items()->count()}}</td>

            <td style="border:none">متراژ کل:
                {{$product_request_form->getAmount("final_amount")}}</td>

            <td style="border:none">وزن کل:
                {{$product_request_form->getAmount("sub_amount")}}</td>
        </tr>
    ...
    <br/>
    <br/>
    @foreach($product_request_form->transport_items as $transport_item)
