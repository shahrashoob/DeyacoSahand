<div class="content" style="">
    ...
    <div style="width: 100%; height: 300px; border: 1px solid #000; font-size: 18px">
        <table style="width: 100%;">
            ...
            @foreach($transport_item->transport_packing_list as $item)
                <tr>
                    ...
                    <td style="font-size: 18px">
                        {{$item->packing_form->items()->first()->product->property1_caption}}
                    </td>
                    <td style="font-size: 18px">
                        {{$item->packing_form->items()->first()->product->property2_caption}}
                    </td>
                    <td style="font-size: 18px">
