        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form id="form1" action="{{route("utility.transport.dashboard.store_transport")}}" method="post"
                          autocomplete="off"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                @include("component.input._checkbox",["id"=>"order_exist","label"=>"آیا شماره سفارش برای مشتری موجود است","checked"=>1])
                            </div>
                            <div id="order_values" class="col-md-12">
                               <div class="row">
    ...
    <script>
        $('#form1').validate({
            rules: {
                "series": "required",
                "order_code": "required",
                "customer_caption": "required",
            }
        });
        $("#switch-order_exist").change(function () {
            if ($(this).is(":checked")) {
                $("#order_values").css("display", "")
            } else {
                $("#order_values").css("display", "none")
            }
        })
    </script>
@endsection
