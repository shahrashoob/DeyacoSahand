...
@section("content")
    <div class="row">
        ...
        <div class="col-sm-12">
            @include("utility.special_license.panel.dashboard._search",["route"=>"utility.special_license.panel.dashboard.my_license"])

            <div class="card">
                <div class="card-header">
                    <h5>لیست همه مجوزهای من
                        ...
                        <table class="table table-styling center">
                            ...
                            @foreach($list as $item)
                                <tr >
                                    <td>{{++$row}}</td>
                                    <td>
                                        <a href="{{route("utility.special_license.panel.dashboard.view",[$item->id])}}">
                                            {{$item->code}}
                                        </a>
                                    </td>
                                    <td>
