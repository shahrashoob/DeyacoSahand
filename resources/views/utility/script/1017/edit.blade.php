                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="row">
                                    ...
                                    @include("component.input._number",["id"=>"check_before_horse",'label'=>"بررسی تحویل شیف از x ساعت قبل از شروع شیفت کاری","value"=>isset($data["check_before_horse"])?$data["check_before_horse"]:"","class_col"=>"col-md-12"])
