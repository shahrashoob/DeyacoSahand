                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="row">
                                    ...
                                    @include("component.input._text",["id"=>"days_for_calculate_allocation_type",'label'=>"تعداد روز جهت محاسبه میانگین زمان تولید در ماژول محاسبه زمان تخصیص","value"=>$data["days_for_calculate_allocation_type"],"class_col"=>"col-md-12"])
