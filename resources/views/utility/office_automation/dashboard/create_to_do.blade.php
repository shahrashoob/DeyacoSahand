...
@section("content")
    ...
    <form id="form1" action="{{route("utility.office_automation.dashboard.store_to_do")}}"
          method="post"
          autocomplete="off"
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="row">
                            @include("component.input._hidden",["id"=>"office_automation_to_do_list_id","value"=>$office_automation_to_do_list->id])
                            ...
                            <div class="col-md-12">
                                    ...
                                    <a href="{{route("utility.office_automation.dashboard.view",[$office_automation_to_do_list->office_automation_work_id,$current_user_id])}}"
