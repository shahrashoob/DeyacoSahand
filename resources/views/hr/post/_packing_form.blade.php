    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="card">
                <div class="card-header">
                    <h5> دسترسی به وضعیت بسته بندی ها </h5>
                </div>
                    ...
                    <div class="row">
                        <div class="table-responsive">
                            <table class="table table-styling">
                                ...
                                <tbody>
                                @php $row=0;@endphp
                                @foreach($packing_status_list as $item)
                                    <tr>
                                        <td>{{++$row}}</td>
                                        <td>
                                            ...
                                            <input class="myCheckBox_module" type="checkbox"
                                                   ...
                                                   name="data[packing_status][{{$item->id}}]" {{$post->has_order_status_permission($item->id)?"checked='checked'":""}}
                                            >
        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-header">
                    <h5> دسترسی به عملیات بسته بندی ها </h5>
                    ...
                    <div class="row">
                        <div class="table-responsive">
                            <table class="table table-styling">
                                ...
                                <tbody>
                                @php $row=0;@endphp
                                @foreach($packing_button_list as $item)
                                    <tr>
                                        <td>{{++$row}}</td>
                                        <td>
                                            ...
                                            <input class="myCheckBox_module_operation" type="checkbox"
                                                   id="switch-data[{{$item->id}}]"
                                                   name="data[packing_button][{{$item->id}}]" {{$post->has_button_permission($item->id) ?"checked='checked'":""}}
                                            >
                                            <b> {{$item->caption}}</b>
                                        </td>
                                        <td>
