...
@section("content")
    <form id="form1" action="{{route( "hr.shift_delivery.illegal_delivery.submit",$post)}}"
          method="post"
          autocomplete="off"
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5> تحویل ماشین های غیر مجاز برای پست {{$post->caption}}</h5>
                    </div>
                    <div class="card-block ">
                        ...
                        <div class="row">
                            ...
                            <div class="alert alert-info md-col-12" style="width: 100%">
                                <h5> همکاری گرامی، ضمن عرض خسته نباشید و خداقوت؛ لطفا کنتور ماشین های زیر را وارد کرده و
                                    بر
                                    روی
                                    دکمه تحویل  کلیک نمایید.</h5>
