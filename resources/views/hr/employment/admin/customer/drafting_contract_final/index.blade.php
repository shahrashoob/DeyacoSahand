...
@section('page_header_title',"کارتابل همکاری با ما/تایید نهایی پیش نویس قرارداد هوشمند مشتری")
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form id="form1" style="display: inline"
                          action="{{route("hr.employment.admin.customer.drafting_contract_final.submit",$employment)}}"
                          method="post"
                        ...
                        <button type="submit" class="btn btn-primary"
                                onclick="return confirm('آیا از تایید نهایی قرارداد هوشمند مشتری اطمینان دارید؟')"
                        >تایید</button>
