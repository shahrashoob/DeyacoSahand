        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form id="form1" action="{{route("hr.employment.admin.customer.tariff.store",$employment)}}" method="post" autocomplete="off"
                        ...
                        <a href="{{route("hr.employment.admin.customer.drafting_contract.index",$employment)}}" class="btn btn-outline-dark">بازگشت</a>
