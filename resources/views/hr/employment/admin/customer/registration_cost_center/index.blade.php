...
@section('page_header_title'," کارتابل همکاری با ما/ثبت مرکز هزینه ")
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>ثبت مرکز تامین/کد تفضیلی مشتری</h5>
                </div>
                <div class="card-block">

                    <form id="form1" style="display: inline"
                          action="{{route("hr.employment.admin.customer.registration_cost_center.submit",$employment)}}"
                          method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                    ...
                                    @include("component.input._aotocomplet2",[
                                        ...
                                        "class_col"=>"",
                                        "url"=>route("hr.employment.admin.customer.cost_center.create",$employment),
