        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form id="form1" action="{{route("hr.employment.admin.personal.cost_center.store",$employment)}}" method="post"
                          autocomplete="off"
                        ...
                        <a href="{{route("hr.employment.admin.personal.financial_information.index",$employment)}}" class="btn btn-outline-dark">بازگشت</a>
