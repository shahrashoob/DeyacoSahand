        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form id="form1" action="{{route("hr.employment.admin.supplier.cost_center.store",$employment)}}" method="post"
                          autocomplete="off"
                        ...
                        <a href="{{route("hr.employment.admin.supplier.registration_cost_center.index",$employment)}}" class="btn btn-outline-dark">بازگشت</a>
