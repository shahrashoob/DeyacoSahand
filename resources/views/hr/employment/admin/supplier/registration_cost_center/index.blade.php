            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form id="form1" style="display: inline"
                          action="{{route("hr.employment.admin.supplier.registration_cost_center.submit",$employment)}}"
                          method="post"
                            ...
                            <div class="col-md-6">
                                @if($company_have_separate_warehousing_software)
                                    @include("component.input._aotocomplet2",[
                                        ...
                                        "class_col"=>"",
                                        "url"=>route("hr.employment.admin.supplier.cost_center.create",$employment),
