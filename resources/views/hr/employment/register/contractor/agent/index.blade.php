...
{{--              action="{{route('hr.employment.register.contractor.agent.submit',$employment->key)}}"--}}
{{--              enctype="multipart/form-data" novalidate="novalidate" autocomplete="false">--}}
{{--            @csrf--}}

            @php $panel_name="agent_contractor" @endphp


            @include("hr.employment.register.contractor.agent._list")
