...
@section('content')
    ...
    <form id="form1" method="post"
          action="{{route('hr.employment.register.personal.educational_course.submit_upload',[$employment->key,$user_educational_course])}}"
          enctype="multipart/form-data" novalidate="novalidate" autocomplete="false">
        @csrf
        @php $panel_name="educational_course" @endphp
        @include("hr.employment.register.personal.educational_course._document")
