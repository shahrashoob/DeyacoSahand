@include("component.input._text", ["id"=>"email", 'label'=>$employment->personal_type_id ==1?"نام کاربری":"نام کاربری مدیر عامل", "value"=>$email??"", "class_col"=>"",
'mark'=>'* (باید شامل حروف انگلیسی باشد)'])
...
@include("component.input.datepicker.jalali_datepicker._jalali_datepicker", [
       "id"=>"date_of_birth",
       'label'=>$employment->personal_type_id == 1?"تاریخ تولد":"تاریخ تولد مدیر عامل",
         'max_date'=>'today',
