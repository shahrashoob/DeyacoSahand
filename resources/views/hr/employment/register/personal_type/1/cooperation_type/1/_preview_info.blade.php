    ...
    @include("component.input._lable", ["id"=>"military_information", 'label'=>"وضعیت خدمت سربازی", "value"=>$employment->worker->military_information->caption ?? "",  "class_col"=>"col-md-6",])
    @endif
