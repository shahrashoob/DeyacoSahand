        ...
        <div class="col-sm-12">
            ...
            <div class="table-responsive">
                <table class="table table-styling" style="text-align: center!important;">
                    ...
                    <tbody>
                    @php $row=$leave_list->firstItem();@endphp
                                ...
                                @if($worker_id_equal_auth_id )
                                    ...
                                    @if( !in_array($item->status_id, [4630003,4630004,4630005,4630007,4630006,4630008]))
                                        <a
                                            ...
                                            href="{{route("hr.personal.leave.cancel",$item)}}"
                                            onclick="return confirm('آیا از انصراف  مرخصی اطمینان دارید؟')"><i
            ...
            <div class="float-left">
                نمايش رکوردهای
                <b>{{$leave_list->firstItem()}}</b>
                تا
                <b>{{$leave_list->lastItem()}}</b>
                از
                <b>{{$leave_list->total()}}</b>
                رکورد موجود
            </div>
            <br/>
            <div class="text-center">
                {{$leave_list->links('pagination::bootstrap-4')}}
            </div>
        </div>
