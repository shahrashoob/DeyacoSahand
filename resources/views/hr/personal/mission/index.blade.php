        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5> ثبت درخواست ماموریت </h5>
                </div>
                <div class="card-block">

                    <form id="form1" action="{{route("hr.personal.mission.submit")}}" method="post" autocomplete="off"
                        ...
                        <div class="row">
                            ...
                            @include("component.input.datepicker.jalali_datepicker._jalali_datepicker",
                                        ["id"=>"start_datetime",
                                        "hasTime"=>1,
                                        "lable"=>" از تاریخ و ساعت ",
                                        "class_col"=>"col-md-3",
                                        "value"=>$mission_request["start_datetime"]])
                            <div class="w-100"></div>
                            @include("component.input.datepicker.jalali_datepicker._jalali_datepicker",
                                        ["id"=>"end_datetime",
                                        "hasTime"=>1,
                                        "lable"=>" تا تاریخ و ساعت ",
                                        "class_col"=>"col-md-3",
                                        "value"=>$mission_request["end_datetime"]])
                            <div class="w-100"></div>
                            @include("component.input._textarea",["id"=>"text","lable"=>" توضیحات ","class_col"=>"col-md-3","value"=>$mission_request["text"]])
