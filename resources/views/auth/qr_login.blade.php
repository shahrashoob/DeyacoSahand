                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-10">
                                    ...
                                    <div style="text-align: {{__("text-align")}}">
                                        <b style="font-size: 16px"> {{__("register_login")}}</b>
                                        <br/>
                                        <br/>
                                        {{__("please enter your mobile")}}
                                    </div>
                                    <div class="form-group">
                                        <input name="mobile" id="mobile" value="" type="number" minlength="11" maxlength="11" class="form-control valid">

                                    </div>


                                        <button  class="btn btn-primary shadow-2 mb-4" style="width: 100%;margin-left: 0px">{{__("login")}}</button>
