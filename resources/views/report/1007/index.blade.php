...
@section("page_header_title","گزارش 1007 - راندومان ماشین آلات بافندگی")
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5>گزارش 1007 - راندومان ماشین آلات بافندگی</h5>
                </div>

                <div class="card-block">
                    <form id="form1" autocomplete="off" action="{{route("report.1007.submit")}}" method="post"
