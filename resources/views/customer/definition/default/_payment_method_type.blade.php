<div class="table-responsive">
    <table class="table table-styling">
        ...
        <tr>
            <td></td>
            <td>استفاده از تنظیمات پیش فرض</td>
            <td>روش پرداخت</td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" class="payment_method" data-id="{{$item->id}}"
                           name="data[payment_method_type][{{$item->id}}][enable]" {{isset( $data_customer_default_setting["payment_method_type"][$item->id]['enable']) &&
                            $data_customer_default_setting["payment_method_type"][$item->id]['enable']?"checked":""}} >
                    {{$item->caption}}
                </td>
                <td>
