...
<div class="table-responsive">
    <table class="table table-styling">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox"
                       name="exit_form_require_draft_permission[enable]" {{ isset($data_customer_default_setting['exit_form']['exit_form_require_draft_permission']['enable']) &&
 $data_customer_default_setting['exit_form']['exit_form_require_draft_permission']['enable'] ? "checked='checked'" : "" }}
                >
            </td>
            <td>
                <input type="checkbox"
                       name="exit_form_require_draft_permission[value]" {{ isset($data_customer_default_setting['exit_form']['exit_form_require_draft_permission']['value']) &&
 $data_customer_default_setting['exit_form']['exit_form_require_draft_permission']['value'] ? "checked='checked'" : "" }}
        ...
        <tr>
            ...
            <td>
                ...
                <input type="checkbox"
                       name="exit_form_require_permission[enable]"{{ isset($data_customer_default_setting['exit_form']['exit_form_require_permission']['enable']) &&
                                        $data_customer_default_setting['exit_form']['exit_form_require_permission']['enable'] ? "checked='checked'" : "" }}
            ...
            <td>
                ...
                <input type="checkbox"
                       name="exit_form_require_permission[value]"{{ isset($data_customer_default_setting['exit_form']['exit_form_require_permission']['value']) &&
        ...
        <tr>
            ...
            <td>
                ...
                <input type="checkbox" id="exit_form_loading_require_permission"
                       name="exit_form_loading_require_permission[enable]"
                        {{isset($data_customer_default_setting['exit_form']['exit_form_loading_require_permission']['enable']) &&
                                         $data_customer_default_setting['exit_form']['exit_form_loading_require_permission']['enable'] ? "checked='checked'" : "" }}
            ...
            <td>
                ...
                <input type="checkbox" id="exit_form_loading_require_permission"
                       name="exit_form_loading_require_permission[value]"
        ...
        <tr>
            ...
            <td>
                ...
                <input type="checkbox"
                       name="exit_form_guarding_require_permission[enable]"
                        {{ isset($data_customer_default_setting['exit_form']['exit_form_guarding_require_permission']['enable']) &&
                                          $data_customer_default_setting['exit_form']['exit_form_guarding_require_permission']['enable'] ? "checked='checked'" : "" }}
            ...
            <td>
                ...
                <input type="checkbox"
                       name="exit_form_guarding_require_permission[value]"
        ...
        <tr>
            ...
            <td>
                ...
                <input type="checkbox" id="checking_carrier_at_delivery_of_product"
                       name="checking_carrier_at_delivery_of_product[enable]"
                        {{ isset($data_customer_default_setting['exit_form']['checking_carrier_at_delivery_of_product']['enable']) &&
                                         $data_customer_default_setting['exit_form']['checking_carrier_at_delivery_of_product']['enable'] ? "checked='checked'" : "" }}
            ...
            <td>
                ...
                <input type="checkbox" id="checking_carrier_at_delivery_of_product"
                       name="checking_carrier_at_delivery_of_product[value]"
        ...
        <tr>
            ...
            <td>
                ...
                <input type="checkbox" id="exit_form_require_demands_permission"
                       name="exit_form_require_demands_permission[enable]"
                        {{ isset($data_customer_default_setting['exit_form']['exit_form_require_demands_permission']['enable']) &&
                                         $data_customer_default_setting['exit_form']['exit_form_require_demands_permission']['enable'] ? "checked='checked'" : "" }}
            ...
            <td>
                ...
                <input type="checkbox" id="exit_form_require_demands_permission"
                       name="exit_form_require_demands_permission[value]"
