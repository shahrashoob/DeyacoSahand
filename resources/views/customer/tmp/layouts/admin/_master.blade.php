...
<html lang="en">
<head>
    @include("customer.tmp.layouts._head")
    @yield("styles")
    <style>
        body {
...
@include("customer.tmp.layouts.admin._navbar")

@include("customer.tmp.layouts._header")
...
@include("customer.tmp.layouts._footer")

@include("customer.tmp.layouts._notification")
@yield("scripts")
</body>
