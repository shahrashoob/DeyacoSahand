    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="form1" action="{{route("accounting.welfare_service.tara.admin.dashboard.submit_decharge",$welfare_service)}}" method="post"
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                @include("component.input._number",["id"=>"amount","label"=>"مقدار کاهش شارژ (ریال) ","value"=>""])
                            </div>
