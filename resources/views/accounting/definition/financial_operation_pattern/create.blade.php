        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form id="form1" action="{{route("accounting.definition.financial_operation_pattern.store")}}" method="post"
                          autocomplete="off"
                          novalidate="novalidate">
                        @csrf
                        <div class="row">
                            @include("component.input._text",["id"=>"caption",'label'=>"عنوان  ","value"=>""])
                            <div class="col-md-6">
                            ...
                            <div class="w-100"></div>
                            <div class="col-md-6">
                                @include("component.input._checkbox",["id"=>"register_detailed_code_for_customer",'label'=>"آیا کد تفضیلی مشتری در سند حسابداری ثبت شود.","checked"=>0])
                            </div>

                            @include("component.input._text",["id"=>"detailed_code_for_customer_number",'label'=>"کد تفضیلی مشتری در تفضیلی زیر ارسال گردد","value"=>""])
