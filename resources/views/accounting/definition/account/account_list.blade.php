        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5>حساب {{$account->fullCaption()}}

                    </h5>
                    <a class="text-success" href="{{route("accounting.definition.account.create_sub_account",$account)}}"> <i
                ...
                <div class="text-center">
                    ...
                    <a class="btn btn-outline-dark" href="{{route("accounting.definition.account.account_list",$account->parent_id)}}"> بازگشت </a>
                    @else
                        <a class="btn btn-outline-dark" href="{{route("accounting.definition.account.index")}}"> بازگشت </a>
