                        ...
                        <div style="text-align: center" class="col-md-12">
                            ...
                            @if($error_count>0)
                                <div class="alert alert-danger">لطفا پس از رفع خطا های موجود دوباره فایل اکسل را
                                    ...
                                    <a href="{{route("import.product.base_and_storage.index")}}" class="btn btn-primary">بارگذاری
                                        مجدد</a>



                           @else
                            <a href="{{route("import.product.base_and_storage.update")}}" class="btn btn-primary">
                                اعمال تغییرات</a>
