            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <div class="table-responsive">
                        ...
                        @include("component.input._lable",["id"=>"","lable"=>"متراژ کل ","value"=>$packing_form->getAmount()." متر ","class_col"=>"col-md-12"])
                        @include("component.input._lable",["id"=>"","lable"=>"متراژ کل نهایی  ","value"=>$sum_final_amount_bands." متر ","class_col"=>"col-md-12"])


                        <form id="form1"
                              action="{{route("packing_form.change_packing.submit_section",[$packing_form,$packing_item->band_code])}}"
                              method="post"
                              autocomplete="off"
                        ...
                        @if(  $latest_packing_sum_before == $sum_final_amount )
                            @if(isset($final_amount_list[$packing_item->band_code+1])  )
                                <br/>
                                <div class="col-md-12" style="text-align: center">

                                    <a href="{{route("packing_form.change_packing.section",[$packing_form,$band_code+1])}}"
                            ...
                            @else
                                ...
                                <div class="col-md-12" style="text-align: center">
                                    <form id="form1"
                                          action="{{route("packing_form.change_packing.end_of_section",$packing_form)}}"
                                          method="post"
                                          autocomplete="off"
                                          novalidate="novalidate">
                                        @csrf
                        ...
                        <div class="col-md-12 center">
                            <br/>
                            <br/>
                            <a href="{{route("packing_form.change_packing.index",$packing_form)}}"
            ...
            <script>
                ...
                $("#packing_type_id").change(function () {
                    ...
                    for (k = 0; k < carrier_count_for_each_packing[$(this).val()]["layer_count"]; k++) {
                        $(".carrier_div_" + k).css("display", "block")
