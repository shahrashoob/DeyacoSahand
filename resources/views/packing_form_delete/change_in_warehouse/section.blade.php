            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <div class="table-responsive">
                        ...
                        @include("component.input._lable",["id"=>"","lable"=>"متراژ  نهایی  ","value"=>$sum_final_amount_bands." متر ","class_col"=>"col-md-12"])


                        <form id="form1"
                              action="{{route("packing_form.change_in_warehouse.submit_section",[$packing_form,$packing_item->band_code])}}"
                              method="post"
                              autocomplete="off"
                            ...
                            @if( $latest_packing_item_temp->final_amount+ $latest_packing_sum_before < $sum_final_amount )
                                <div class="row alert alert-info"
                                    ...
                                    @include("component.input._number",["id"=>"end_point","class_col"=>"col-md-4 col-xs-12","autofocus"=>1,"label"=>" از متراژ ".$latest_packing_sum_before." تا متراژ ","value"=>""])
                        ...
                        @if(  $latest_packing_sum_before == $sum_final_amount )
                            @if(isset($final_amount_list[$packing_item->band_code+1])  )
                                ...
                                <div class="col-md-12" style="text-align: center">
                                    ...
                                    <a href="{{route("packing_form.change_in_warehouse.section",[$packing_form,$band_code+1])}}"
                            ...
                            @else
                                ...
                                <div class="col-md-12" style="text-align: center">
                                    <form id="form1"
                                          action="{{route("packing_form.change_in_warehouse.end_of_section",$packing_form)}}"
                                          method="post"
                                          autocomplete="off"
                                          novalidate="novalidate">
                                        @csrf
