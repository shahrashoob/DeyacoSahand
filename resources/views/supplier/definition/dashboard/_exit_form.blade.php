    ...
    <table class="table table-styling">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="checkbox" id="exit_form_require_quality_permission"
                       name="exit_form_require_quality_permission"
                        {{$data_supplier_default_setting->exit_form_require_quality_permission->value?"checked":""}}
                        {{$data_supplier_default_setting->exit_form_require_quality_permission->enable ? 'disabled' : ''}}
                >
            ...
            <td>
                ...
                <input type="checkbox" id="exit_form_require_draft_permission"
                       name="exit_form_require_draft_permission"
                        {{$data_supplier_default_setting->exit_form_require_draft_permission->value?"checked":""}}
                        {{$data_supplier_default_setting->exit_form_require_draft_permission->enable ? 'disabled' : ''}}
                >
            ...
            <td>
                ...
                <input type="checkbox" id="exit_form_require_permission"
                       name="exit_form_require_permission"
                        {{$data_supplier_default_setting->exit_form_require_permission->value?"checked":""}}
                        {{$data_supplier_default_setting->exit_form_require_permission->enable ? 'disabled' : ''}}
                >
            ...
            <td>
                ...
                <input type="checkbox" id="exit_form_loading_require_permission"
                       name="exit_form_loading_require_permission"
                        {{$data_supplier_default_setting->exit_form_loading_require_permission->value?"checked":""}}
                        {{$data_supplier_default_setting->exit_form_loading_require_permission->enable ? 'disabled' : ''}}
                >
            ...
            <td>
                ...
                <input type="checkbox" id="exit_form_guarding_require_permission"
                       name="exit_form_guarding_require_permission"
                        {{$data_supplier_default_setting->exit_form_guarding_require_permission->value?"checked":""}}
                        {{$data_supplier_default_setting->exit_form_guarding_require_permission->enable ? 'disabled' : ''}}
                >
