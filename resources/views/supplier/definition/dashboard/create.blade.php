...
@section("content")
    ...
    <form id="form1" style="display: inline" action="{{route("supplier.definition.dashboard.store")}}" method="post"
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="col-md-12" style="text-align: center">
                        <a href="{{route("supplier.definition.dashboard.index")}}" class="btn btn-outline-dark btn-lg">بازگشت</a>
