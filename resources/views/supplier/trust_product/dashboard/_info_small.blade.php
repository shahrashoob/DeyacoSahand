<div class="row">
    ...
    @include("component.input._lable",["id"=>"","lable"=>"   شماره سفارش","value"=>$production->order->code??""])
    @include("component.input._lable",["id"=>"","lable"=>"   مشتری","value"=>$production->order->customer->caption??""])
    ...
    @include("component.input._lable",["id"=>"","lable"=>" کالا ","value"=>$production->product->fullCaption()])


    @include("component.input._lable",["id"=>"","lable"=>"   مقدار کارت ","value"=>$production->number()])
