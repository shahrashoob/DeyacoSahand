...
return [
    ...
    */
    ...
    'failed' => 'نام کاربری یا کلمه عبور نادرست است.',
    'password' => 'رمز ورود نادرست است.',
    'throttle' => 'تلاش برای ورود به سیستم بسیار زیاد است، لطفا چند دقیقه دیگر تلاش کنید',
